...
config = utilities.get_facebook_config()
...
url = "https://www.facebook.com/tacoma.purepm/reviews"
chrome_options = Options()
driver = webdriver.Chrome(options=chrome_options)
...
initial_modal_selector = config["selectors"]["initial_sign_in_modal"]

close_button = check_if_exists(driver, get_attribute(initial_modal_selector["by"]), initial_modal_selector["selector"])
close_button.click()
